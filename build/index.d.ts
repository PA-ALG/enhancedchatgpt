...
declare class ChatGPTAPI {
    ...
    protected _updateMessages(oldMessage: openai.ChatCompletionRequestMessage[],
                              maxTokens: number, numTokens: number, opts: SendMessageOptions): Promise<{
        messages: openai.ChatCompletionRequestMessage[];
        maxTokens: number;
        numTokens: number;
    }>;
